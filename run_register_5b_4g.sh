...
OUTDIR=outputs/elf_b-owt-register-5b-4g
LOGDIR=logs/register_5b_4g
LOGFILE=$LOGDIR/train_register_4g_5b.log

mkdir -p "$LOGDIR"

echo "============================================================"
echo "Register ELF 5B run"
echo "Config: src/configs/training_configs/train_owt_ELF-B_register.yml"
...
echo "NOTE: register has plan slots, but plan input is pure noise and has no plan loss."
echo "============================================================"

set +e
NGPU=4 bash scripts/launch.sh train src/configs/training_configs/train_owt_ELF-B_register.yml \
  ...
  --config_override ddp_find_unused_parameters=true \
