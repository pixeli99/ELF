...
OUTDIR=outputs/elf_b-owt-vanilla-5b-4g
LOGDIR=logs/vanilla_5b_4g
LOGFILE=$LOGDIR/train_vanilla_4g_5b.log

mkdir -p "$LOGDIR"

echo "============================================================"
echo "Vanilla ELF-B 5B continuation run"
echo "Config: src/configs/training_configs/train_owt_ELF-B.yml"
...
echo "NOTE: vanilla has num_plan_slots=0, no plan/register slots."
echo "============================================================"

set +e
NGPU=4 bash scripts/launch.sh train src/configs/training_configs/train_owt_ELF-B.yml \
